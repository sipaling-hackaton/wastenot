...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center" style={{backgroundImage:"url('./image/bg-home.png')",backgroundSize:"contain",backgroundRepeat:"no-repeat"}}>
      ...
      <div className="section2">
        ...
        <div style={{width: "100%",height:"200px",paddingBottom:"20px"}}><iframe width="100%" height="300"  src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Jl%20Scientia%20Square%20Barat%201+(My%20Business%20Name)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.gps.ie/">gps devices</a></iframe></div>
      </div>
    </main>
  );
}
